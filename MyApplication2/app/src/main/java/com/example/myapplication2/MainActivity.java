...
public class MainActivity extends AppCompatActivity {
    ...
    * */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main___mountains_by_region);
        ...
        adapter.addDto(new SingerDTO("남산",
                "010-1111-1111", 25, R.drawable.namsan));
        adapter.addDto(new SingerDTO("북한산",
                "010-1111-2222", 27, R.drawable.buk_han_san));
        adapter.addDto(new SingerDTO("관악산",
                "010-1111-3333", 25, R.drawable.g_ak));
        adapter.addDto(new SingerDTO("낙산",
                "010-1111-4444", 35, R.drawable.nack_san));
        adapter.addDto(new SingerDTO("도봉산",
                "010-1111-5555", 29, R.drawable.do_bong_san));
        adapter.addDto(new SingerDTO("수락산",
